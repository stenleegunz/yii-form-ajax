...
class TbActiveForm extends CActiveForm
{
	 ...
	 * @return string the generated row
	 */
	public function checkBoxListInlineRow($model, $attribute, $data = [], $htmlOptions = [])
	{
	 ...
	 * @return string the generated row
	 */
	public function radioButtonRow($model, $attribute, $htmlOptions = [])
	{
	 ...
	 * @return string the generated row
	 */
	public function radioButtonListInlineRow($model, $attribute, $data = [], $htmlOptions = [])
	{
	 ...
	 * @since 0.9.3
	 */
	public function captchaRow($model, $attribute, $htmlOptions = [])
	{
	 ...
	 * @since 0.9.5
	 */
	public function uneditableRow($model, $attribute, $htmlOptions = [])
	{
	 ...
	 * @since 0.9.5
	 */
	protected function inputsList($checkbox, $model, $attribute, $data, $htmlOptions = [])
	{
	...
	public function error($model, $attribute, $htmlOptions = [], $enableAjaxValidation = true, $enableClientValidation = true)
	{
		...
		{
			$validators = isset($htmlOptions['clientValidation']) ? [$htmlOptions['clientValidation']] : [];
	 ...
	 * @see errorMessageCss
	 */
	protected static function renderError($model, $attribute, $htmlOptions = [])
	{
	 ...
	 * @return string the generated row
	 */
	public function inputRow($type, $model, $attribute, $data = null, $htmlOptions = [])
	{
		ob_start();
		$this->getOwner()->widget($this->getInputClassName(), [
            'form'=>$this,
            'type'=>$type,
			'model'=>$model,
			'attribute'=>$attribute,
