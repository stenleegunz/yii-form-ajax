...
class TbAlert extends CWidget
{
	...
	public function init()
	{
		...
		if (!isset($this->alerts))
			$this->alerts = [self::TYPE_SUCCESS, self::TYPE_INFO, self::TYPE_WARNING, self::TYPE_ERROR, self::TYPE_DANGER];
	}
	...
	public function run()
	{
		...
		foreach ($this->alerts as $type => $alert)
		{
			...
			if (Yii::app()->user->hasFlash($type))
			{
				...
				$validTypes = [self::TYPE_SUCCESS, self::TYPE_INFO, self::TYPE_WARNING, self::TYPE_ERROR, self::TYPE_DANGER];
